...
<body>
 ...
 <h3 class=" h2 text-center font-weight-bold text-success">Details Products</h3>
 <div class="container">
 		...
 		<thead class="bg-secondary text-light" >
 			...
 			<tbody> 
 				...
 				<tr style="text-align: center;">
 					...
 					<td>
 						<img src="img/product_img/<?php echo $pro_image;?>.jpg" alt="mobile pics" style="height:50px; width: 60px;">
 					</td>
 					<td>
 						<a href="home.php?page=detail&&pro_id=<?php print $fetch_result[2]?>"><button class="btn btn-primary">Details</button></a>
 					</td>
 				</tr>
 				<?php
 					}
